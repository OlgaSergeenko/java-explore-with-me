...
@EnableJpaRepositories(
        entityManagerFactoryRef = StatsDbConfig.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = StatsDbConfig.TRANSACTION_MANAGER,
        basePackages = StatsDbConfig.JPA_REPOSITORY_PACKAGE
)
public class StatsDbConfig {

    public static final String PROPERTY_PREFIX = "app.statdb.datasource";
    public static final String JPA_REPOSITORY_PACKAGE = "ru.practicum";
    public static final String ENTITY_PACKAGE = "ru.practicum";
    public static final String ENTITY_MANAGER_FACTORY = "statEntityManagerFactory";
    public static final String DATA_SOURCE = "statDataSource";
    public static final String DATABASE_PROPERTY = "statDatabaseProperty";
    public static final String TRANSACTION_MANAGER = "statTransactionManager";
